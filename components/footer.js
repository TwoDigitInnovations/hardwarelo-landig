      ...
      <footer className="bg-gradient-to-br bg-white from-[#0D34BF] via-[#0D34BF] to-[#0D34BF] relative overflow-hidden rounded-t-[3rem] ">
        ...
        <div className="max-w-7xl mx-auto px-8 py-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            {/* Google Play Button */}
            <div className="bg-black rounded-lg px-6 py-3 flex items-center space-x-3 hover:bg-gray-800 transition-colors cursor-pointer" onClick={() => window.open('https://play.google.com/store/apps/details?id=com.hardwarelo.app', '_black')}>
            ...
            {/* App Store Button */}
            <div className="bg-black rounded-lg px-6 py-3 flex items-center space-x-3 hover:bg-gray-800 transition-colors cursor-pointer" onClick={() => window.open('https://apps.apple.com/us/app/hardwarelo/id6747817935', '_black')}>
              <div className="text-white">
                <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
